...
function setTable(top5, probs) {
    ...
    for (var i = 0; i < top5.length; i++) {
        ...
        // 소숫점 2번째자리까지 출력되게 한다.
        prob.innerHTML = Math.round(probs[i] * 10000) / 100
    }
    //create the pie
...
function success(data) {
    ...
    // 학습에 사용한 Class 이름을 참고용으로 HTML 문서에 출력시켜준다.
    ul = document.createElement('ul');
    document.getElementById('myClassList').append(ul);
...
function allowDrawing() {
    ...
    document.getElementById('status').innerHTML = '모델 불러오기 완료';
